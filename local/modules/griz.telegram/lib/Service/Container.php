 ...
 * ==================================================
 */
namespace Griz\Telegram\Service;

use Griz\Telegram\Internals\Model\RecordTable;
use Griz\Telegram\Service\Xml\FtpDataReader;
use Griz\Telegram\Service\Xml\XmlParser;
use Bitrix\Main\ArgumentException;
use Bitrix\Main\DI\ServiceLocator;
use Griz\Telegram\Service\Message\Mailer;
use Griz\Telegram\Service\Message\Sms;
use Griz\Telegram\Service\OneC\Reader;
use Griz\Telegram\Service\OneC\Writer;
use Exception;

/**
 * Class Container
 * @package Griz\Telegram\Service
 */
class Container
{
